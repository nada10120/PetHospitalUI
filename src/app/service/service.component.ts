...
export class ServiceComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    console.log('Sending', this.editingServiceId ? 'PUT' : 'POST', 'request to', this.editingServiceId ? `https://localhost:7202/api/Admin/Services/${this.editingServiceId}` : 'https://localhost:7202/api/Admin/Services');
